...
docker stop ums_server_singapore_0

sleep 3

docker rm -v ums_server_singapore_0

docker run --name=ums_server_singapore_0 -d -p 8081:8081 -p 8080:8080 -p 8088:8088 -p 8099:8099 -p 8082:8082 -p 9821:9821\
    -e UMSCLOUD_SERVER_OPTS="-Denv=singapore -Dserver_id=ums_server_0 -Dserver_num=0 -Dcluster_id=1 -Dums_test_model=auto -Xdebug -Xrunjdwp:server=y,transport=dt_socket,address=8099,suspend=n \
    ...
    -v /root/.aws:/root/.aws \
    -v /data2/logs/ums_server_singapore_0/:/logs/server/ docker.tiejin.cn/umscloud-server:latest \
