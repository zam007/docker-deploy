...
## ums_fileserver_singapore_1
docker stop ums_fileserver_singapore_1
sleep 3
docker rm -v ums_fileserver_singapore_1

docker run --name=ums_fileserver_singapore_1 -d -p 2088:2088 -p 2099:2099 -e UMSCLOUD_FILESERVER_OPTS="-Denv=singapore\
 -server -Xmx3600m -Xss512k -Dfile.encoding=utf-8 -XX:MaxMetaspaceSize=100m\
    ...
    -v /data2/logs/ums_fileserver_singapore_1/:/logs/server/ docker.tiejin.cn/umscloud-fileserver:latest
