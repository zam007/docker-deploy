...
## ums_scheduler_test_0
docker stop ums_scheduler_test_0
sleep 3
docker rm -v ums_scheduler_test_0

docker run --name=ums_scheduler_test_0 -d -p 8085:8085 -e UMSCLOUD_SCHEDULER_OPTS="-Denv=sandbox\
