...
config = {
    ...
    production: {
        url: 'https://blog.grouk.com',
        mail: {
              transport: 'SMTP',
              options: {
                  service: 'Mailgun',
                  auth: {
                      user: 'blog@grouk.com', // mailgun username
                      pass: 'GcQ46WuPFg'  // mailgun password
                  }
              }
         }, 
	/**
	...
	**/
        ...
        database: {
            client: 'mysql',
            connection: {
                host     : 'devtools.cbsazrx5drj0.rds.cn-north-1.amazonaws.com.cn',
                user     : 'devtools',
                password : 'umscloud_devtools_301',
                database : 'blog',
                charset  : 'utf8'
            },
            debug: false
        ...
        storage: {
            provider: 'qiniu',
            bucketname: 'grouk-public',
            ACCESS_KEY: 'JE-B6M15vZqNKz7WVuUBtjUllTTMcyFTVbVxbjCs',
            SECRET_KEY: '5CbBE9ELWeNSxwdO1D3LpgT2dKhGeH63KjtC0Skl',
            root: '/blog-img/',
            prefix: 'https://dn-grouk-public.qbox.me'
        }
